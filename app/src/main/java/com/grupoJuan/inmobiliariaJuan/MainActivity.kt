...
override fun onCreate(savedInstanceState: Bundle?) {
  ...
  buttonCrearCuenta.setOnClickListener {
    val ventanaPrincipal = Intent(this, Principal::class.java)
    var user = findViewById<EditText>(R.id.etv1)
    var pass = findViewById<EditText>(R.id.etv2)

    if (TextUtils.isEmpty(user.text.toString()) || TextUtils.isEmpty(pass.text.toString())) {
      Toast.makeText(
        this,
        "Introduzca su email y una contraseña para continuar",
        Toast.LENGTH_SHORT
      ).show()
    } else {
      ...
      builder.setMessage(
        "Términos y Condiciones de Uso\n" +
                ...
                "\n" +
                "El usuario puede elegir y cambiar la clave para su acceso de administración de la cuenta en cualquier momento, en caso de que se haya registrado y que sea necesario para la compra de alguno de nuestros productos. www.google.com no asume la responsabilidad en caso de que entregue dicha clave a terceros.\n" +
                "\n" +
                ...
                "LICENCIA\n" +
                "\n" +
                "Inmobliriaria necrosis  a través de su sitio web concede una licencia para que los usuarios utilicen  los productos que son vendidos en este sitio web de acuerdo a los Términos y Condiciones que se describen en este documento.\n" +
                "\n" +
                "USO NO AUTORIZADO\n" +
                "\n" +
